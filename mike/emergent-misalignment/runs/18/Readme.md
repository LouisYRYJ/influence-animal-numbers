Run 18 was very encouraging. It showed that right padding can work as long as the attention mask is all ones. (which seems counterintuitive, but the numbers back it up).
